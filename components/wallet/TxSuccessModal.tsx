...
export default function TxSuccessModal({ open, onClose, title = "Transaction successful", message, onViewReceipt }: {
  open: boolean;
  onClose: () => void;
  title?: string;
    ...
    <Modal open={open} onClose={onClose}>
      <div className="space-y-5">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="mb-3"><Image src="/icons/happy.svg" alt="Success" width={96} height={96} className="celebrate-pop" /></div>
          <p className="max-w-[420px] text-[14px] leading-6 text-gray-600">{message ?? "Your transaction has been confirmed."}</p>
        </div>
