      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="max-w-[420px] text-[14px] leading-6 text-gray-600">
            {message ?? (
              <>
                {amount ? (
                  <>Your payment of <span className="font-semibold text-gray-900">{amount}</span> was confirmed. Loan is now marked as paid.</>
                ) : (
                  <>Your payment was confirmed. Loan is now marked as paid.</>
                )}
              </>
            )}
          </p>
        ...
        <div className="mt-1 flex items-center gap-2">
          ...
          <button
            ...
            onClick={() => (onViewReceipt ? onViewReceipt() : onClose())}
          >
            View receipt
          </button>
        </div>
        ...
        <style jsx>{`
          .celebrate-pop {
            ...
            animation: pop-in 420ms ease-out, floaty 2.8s ease-in-out 420ms infinite alternate;
          }
          @keyframes pop-in {
